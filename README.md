...
<svg width="100%" height="180" viewBox="0 0 900 180" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect width="900" height="180" fill="url(#headerGrad)" rx="0"/>
  <path d="M0,140 Q225,100 450,130 Q675,160 900,120 L900,180 L0,180 Z" fill="rgba(0,0,0,0.2)"/>
  <text x="450" y="80" font-family="Arial,sans-serif" font-size="36" font-weight="bold" fill="#ffffff" text-anchor="middle">🧠 Age &amp; Gender Prediction</text>
  <text x="450" y="120" font-family="Arial,sans-serif" font-size="15" fill="#a8d8ea" text-anchor="middle">Deep Learning | CNN | Face Analysis | Food Recommendation</text>
</svg>

[![License](https://img.shields.io/badge/License-MIT-0f2027?style=for-the-badge)](#-license)
...
| 👁️ Face Detection | OpenCV DNN | **Real-time** |
...
- Multi-output model training (regression + classification)
...
<svg width="100%" height="100" viewBox="0 0 900 100" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M0,0 Q225,50 450,20 Q675,-10 900,40 L900,100 L0,100 Z" fill="url(#footerGrad)"/>
</svg>
